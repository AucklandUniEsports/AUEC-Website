...
export default function AboutSection() {
    return (
        <section className="flex flex-col px-7 md:px-0 pt-8 pb-12 gap-4">
            <div className="flex gap-4 object-cover h-[45vh] md:h-[65vh] w-full">
            ...
            <div className="pl-5 md:pl-16 flex flex-col gap-4 -mt-10 md:-mt-24">
                <h2 className="text-white font-['Syne'] text-[40px] md:text-[60px] lg:text-[100px] scale-y-75 font-medium not-italic leading-[0.8] tracking-[1.2px] uppercase">
