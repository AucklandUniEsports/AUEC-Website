...
// Faster power-on: 1.6s (was 4.6s), same "catching" shape, compressed.
...
const POWER_ON_DURATION = 1.6;

// Faster, snappier idle flicker: 3.2s loop (was 7s) with quicker dips.
const IDLE_VALUES = [1, 1, 0.06, 1, 0.08, 1, 1];
const IDLE_TIMES = [0, 0.8, 0.84, 0.88, 0.92, 0.95, 1];
const IDLE_DURATION = 3.2;
...
export default function Watermark() {
    ...
    return (
        <span ref={ref} className="home-a-watermark" aria-hidden="true">
            AUEC
        </span>
    );
}
