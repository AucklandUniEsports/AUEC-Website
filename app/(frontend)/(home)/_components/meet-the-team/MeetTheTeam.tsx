...
export default function TeamSection() {
    return (
        <section className="relative flex h-[80svh] items-center justify-center text-center overflow-hidden">
            <img
                className="absolute h-full w-full object-cover object-[center_45%]"
                src="DSC00858.webp"
                alt=""
            />
            <span
                ...
                font-['Syne'] font-medium tracking-tight opacity-80 whitespace-nowrap
            ...
            <div className="relative z-[2] flex max-w-[720px] flex-col items-start gap-5 px-5 text-left md:items-center md:px-0 md:text-center">
                <h2 className="mt-10 md:mt-0 !font-['Syne'] text-[56px] md:text-[72px] font-medium leading-[130%] text-white">
                    MEET THE TEAM.
                </h2>

                <p className="mt-25 md:mt-0 max-w-[600px] !font-['Syne'] text-[18px] md:text-[20px] tracking-[-0.3px] md:tracking-[0.7px] text-[#cfced2]">
